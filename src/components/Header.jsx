  ...
  return (
    <header className="w-full flex flex-col items-center justify-between text-white text-center z-50 md:flex-row pt-4">
      ...
      <nav className="flex gap-2 w-full md:justify-end">
        <NavLink
          to="/ranking"
          className="w-full md:w-fit px-4 py-2 fill-white flex gap-2 items-center rounded-lg bg-[#f2f2f20f] hover:bg-[#f2f2f233] border border-[#f2f2f20a] hover:border-[#f2f2f21a] backdrop-blur-md transition-all duration-400 ease-[cubic-bezier(.165,.84,.44,1)] text-lg"
        >
          <MedalIcon />
