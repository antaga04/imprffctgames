...
export function ArrowUpIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
            <path d="M3.7875 15L3 14.2125L12.3375 4.875H6.825V3.75H14.25V11.175H13.125V5.6625L3.7875 15Z" />
        </svg>
    );
}
...
export function RegisterUserIcon() {
    return (
        <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 fill-gray-500 peer-focus:text-gray-900"
        >
...
export function AtSymbolIcon() {
    return (
        ...
        >
            <path d="M16.5 12a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 10-2.636 6.364M16.5 12V8.25"></path>
        </svg>
    );
}
